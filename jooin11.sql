...
SELECT veiculo.matricula AS Matricula, clientes.nom AS Nome_Proprietario
FROM veiculo JOIN clientes ON veiculo.clientes_nif = clientes.nif;
#b
SELECT clientes.nif AS NIF, clientes.nom AS Nome
FROM veiculo JOIN clientes ON veiculo.clientes_nif = clientes.nif
